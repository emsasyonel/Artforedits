...
<hr>
    ...
    <div class="row">
      ...
      <a href="enyeniler.php"><img src="./carousel img/indir (6).jpeg" class="d-block w-100" alt="..."></a>
      </div>
        <div class="carousel-item">
        <a href="enyeniler.php"><img src="./carousel img/indir (7).jpeg" class="d-block w-100" alt="..."></a>
        </div>
        <div class="carousel-item">
        <a href="enyeniler.php"><img src="./carousel img/indir (8).jpeg" class="d-block w-100" alt="..."></a>
        </div>
      </div>
